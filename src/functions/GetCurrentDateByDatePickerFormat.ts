export function getCurrentDateByDatePickerFormat(){
...
export function getStrDayMonth(value: number) {
    return value >= 10 ? "" + value : "0" + value;
  }

  export function getCurrentDateFromDatePickerFormat(value:string) {
